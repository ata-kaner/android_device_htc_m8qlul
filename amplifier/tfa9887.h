...
#define CONFIG_TFA9887 "/system/vendor/etc/tfa/tfa9895.config"
#define PATCH_TFA9887 "/system/vendor/etc/tfa/tfa9895.patch"

#define SPKR_R "/system/vendor/etc/tfa/tfa9895.speaker"
#define SPKR_L "/system/vendor/etc/tfa/tfa9895_l.speaker"

#define PRESET_PLAYBACK_R "/system/vendor/etc/tfa/playback.preset"
#define PRESET_PLAYBACK_L "/system/vendor/etc/tfa/playback_l.preset"
#define PRESET_VOICE_R "/system/vendor/etc/tfa/voice.preset"
#define PRESET_VOICE_L "/system/vendor/etc/tfa/voice_l.preset"
#define PRESET_VOIP_R "/system/vendor/etc/tfa/voip.preset"
#define PRESET_VOIP_L "/system/vendor/etc/tfa/voip_l.preset"

#define EQ_PLAYBACK_R "/system/vendor/etc/tfa/playback.eq"
#define EQ_PLAYBACK_L "/system/vendor/etc/tfa/playback_l.eq"
#define EQ_VOICE_R "/system/vendor/etc/tfa/voice.eq"
#define EQ_VOICE_L "/system/vendor/etc/tfa/voice_l.eq"
#define EQ_VOIP_R "/system/vendor/etc/tfa/voip.eq"
#define EQ_VOIP_L "/system/vendor/etc/tfa/voip_l.eq"

#define DRC_PLAYBACK_R "/system/vendor/etc/tfa/playback.drc"
#define DRC_PLAYBACK_L "/system/vendor/etc/tfa/playback_l.drc"
#define DRC_VOICE_R "/system/vendor/etc/tfa/voice.drc"
#define DRC_VOICE_L "/system/vendor/etc/tfa/voice_l.drc"
#define DRC_VOIP_R "/system/vendor/etc/tfa/voip.drc"
#define DRC_VOIP_L "/system/vendor/etc/tfa/voip_l.drc"
