...
public class BacklightDimmerPreference extends Preference implements
    ...
    private static final String FILE_LEVEL = "/sys/devices/soc.0/1a00000.qcom,mdss_mdp/qcom,mdss_fb_primary.132/leds/lcd-backlight/max_brightness";
    public static final String SETTINGS_KEY = DeviceSettings.KEY_SETTINGS_PREFIX + DeviceSettings.KEY_BACKLIGHT_DIMMER;
    public static final String DEFAULT_VALUE = "200";
